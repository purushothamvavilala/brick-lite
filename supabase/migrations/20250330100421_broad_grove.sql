/*
  ...
  1. Changes
    - Remove any existing demo users
    - Create fresh demo user with proper auth setup
    - Set up business settings for demo user
    
  2. Security
    - Use Supabase's native password hashing
    - Set up proper identity records
